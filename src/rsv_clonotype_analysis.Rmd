...
recon_res %>%
  ggpubr::ggdotplot(x = "Group_specificity", y = "est_0.0D", fill = "Group_specificity", group = "Group_specificity", 
                    legend = "none",size = 2) +
  geom_vline(xintercept = seq(2.5,12,2), linetype = "dotted") +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 300)) +
  scale_x_discrete(expand = c(0, 0)) +
...
recon_res %>%
  ggpubr::ggdotplot(x = "Group_specificity", y = "est_2.0D", fill = "Group_specificity", group = "Group_specificity", 
                    legend = "none", size = 2) +
  geom_vline(xintercept = seq(2.5,12,2), linetype = "dotted") +
...
rds_summary_noPV %>%
  ggpubr::ggdotplot(x = "Group_specificity", y = "unique_v_j", fill = "Group_specificity", 
                    group = "Group_specificity", legend = "none", size = 2) +
  geom_vline(xintercept = seq(2.5,12,2), linetype = "dotted") +
...
## Process selected LORs with individualized database for plotting
...
## Plot SHM over time for individualized database 
...
```{r align_and_tree, engine = 'bash', message = FALSE, warning = FALSE}
